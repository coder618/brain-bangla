    ...
    const boxContents = [
        {
            ...
            icon: (
                <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-4 text-blue-500 rotate-3">
                    <svg
                        className="w-8 h-8"
                        fill="none"
                        stroke="currentColor"
        ...
        },
        {
            ...
            icon: (
                <div className="w-16 h-16 bg-rose-50 rounded-2xl flex items-center justify-center mb-4 text-[#f84c63] -rotate-3">
                    <svg
                        className="w-8 h-8"
                        fill="none"
                        stroke="currentColor"
        ...
        },
        {
            ...
            icon: (
                <div className="w-16 h-16 bg-emerald-50 rounded-2xl flex items-center justify-center mb-4 text-emerald-500 rotate-3">
                    <svg
                        className="w-8 h-8"
                        fill="none"
                        stroke="currentColor"
